...
The data in this test is from a fictional company, FutureHome, that produces futuristic home automation products. For this analysis assessment, please use the database called `futurehome` or see the csv dumps of the data in the `CSVs` folder. The analysis of this assessment can be completed in any combination of python, sql, and/or excel while the formal write up of the results should be in a format that allows the presentation of both text and visualizations. 
